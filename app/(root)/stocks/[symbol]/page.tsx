...
export default async function StockDetails({ params }: StockDetailsPageProps) {
  ...
  // Check if user is authenticated and if stock is in their watchlist
  ...
  try {
    ...
    // If database is not connected or user is not authenticated, keep isInWatchlist as false
    console.log('Could not check watchlist status:', error?.message);
  }
